...
public class Quick {
	...
	public static final int WIDTH = 1344, HEIGHT = 960;
	public static final int TILE_SIZE = 64;
	
	public static void BeginSession() {
		Display.setTitle("Patryk's Tower Defence");
		try {
	...
	public static void DrawQuadTex(float x, float y, float width, float height) {
		glBegin(GL_QUADS);
		glVertex2f(x, y);
